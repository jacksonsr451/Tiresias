Tiresias made by Josquin Debaz for association Doxa [http://prosperologie.org](http://prosperologie.org)

Download directly the zipfile of the last version : [Linux](https://github.com/josquindebaz/Tiresias/archive/refs/heads/master.zip)

For Windows users, an almost up to date .exe is available on [Windows]()

Code available on [Github](https://github.com/josquindebaz/Tiresias)

Help, comments and suggestions: [http://prosperologie.org/forum/viewtopic.php?f=16&t=445](http://prosperologie.org/forum/viewtopic.php?f=16&t=445)
